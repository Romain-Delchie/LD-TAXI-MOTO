...
export default function LegalTerms({ closeModal }) {
  return (
    <div className="modal">
      <svg
      ...
      <p>
        ...
        <a href="https://www.ldtaximoto.com/">https://www.ldtaximoto.com/</a>{" "}
      ...
      <p>
        <strong>Propriétaire</strong> : SAS LD TAXI MOTO Capital social de 1500€
        Numéro de TVA: 981619752 – 15 chemin de Meaux 93360 Neuilly-Plaisance
        <br />
        <strong>Responsable publication</strong> : LD TAXI MOTO –
        ldtaximoto@outlook.com
        <br />
        Le responsable publication est une personne physique ou une personne
        morale.
        <br />
        <strong>Webmaster</strong> : Romain Delchie – romaindelchie@yahoo.fr
        <br />
        <strong>Hébergeur</strong> : Vercel – 340 S Lemon Ave #4133 CA 91789
        Walnut (559) 288-7060
        <br />
        <strong>Délégué à la protection des données</strong> : LD TAXI MOTO –
        ldtaximoto@outlook.com
        <br />
      </p>
      ...
      <p>
        Le site internet{" "}
        <a href="https://www.ldtaximoto.com/">https://www.ldtaximoto.com/</a> a
        pour objet de fournir une information concernant l’ensemble des
        activités de la société.
        <a href="https://www.ldtaximoto.com/">
          https://www.ldtaximoto.com/
        </a>{" "}
      ...
      <p>
        ...
        <a href="https://www.ldtaximoto.com/">https://www.ldtaximoto.com/</a> ne
      ...
      <p>
        <a href="https://www.ldtaximoto.com/">https://www.ldtaximoto.com/</a> et
      ...
      <p>
        ...
        <a href="https://www.ldtaximoto.com/">https://www.ldtaximoto.com/</a> se
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : LD TAXI MOTO.{" "}
        <a href="https://www.ldtaximoto.com/">https://www.ldtaximoto.com/</a>est
        représenté par Lionel DENIS, son représentant légal
      </p>
      <p>
      ...
      <p>
        ...
        de <a href="https://www.ldtaximoto.com/">https://www.ldtaximoto.com/</a>{" "}
      ...
      LD TAXI MOTO – DPO, LD TAXI MOTO <br />
      15 chemin de Meaux 93360 Neuilly-Plaisance.
      <p>
      ...
      <p>
        ...
        être le cas lorsque{" "}
        <a href="https://www.ldtaximoto.com/">https://www.ldtaximoto.com/</a> ou
      ...
      <p>
        ...
        <a href="https://www.ldtaximoto.com/">https://www.ldtaximoto.com/</a>. À
